...
class Librarian(gym.Env):
    def __init__(self, env_config):
        ...
        self.observation_space = Box(0, 1, shape=((self.obs_size + 1) * self.max_items_per_chest * len(self._env_items), ), dtype=numpy.float32)
    ...
    def init_malmo(self):
        ...
        for retry in range(max_retries):
            try:
                self.agent.startMission( my_mission, my_clients, my_mission_record, 0, 'Librarian' + str(self.episode_number) )
                break
