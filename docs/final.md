...
#### Benchmark Greedy
Our "Greedy" benchmarks consisted of 2 basic steps; gather the estimated distribution of the requester, which would be as any entity would survey or gather information about a population by gathering their preferences, and then averaging this distribution, to approximate the distribution of the requester. With this approximated distribution, we could create
